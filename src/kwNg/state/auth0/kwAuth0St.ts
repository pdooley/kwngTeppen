...
export class kwAuth0StApi extends kwBsStApi
{
    constructor(){super()}
}
...
@Injectable({providedIn: 'root'})
export class kwAuth0StArr extends kwBsStArr
{
...
@Injectable({providedIn: 'root'})
export class kwAuth0StMdl extends kwBsStMdl
{
    constructor(){super()}
}
...
@Injectable({providedIn: 'root'})
export class kwAuth0StMsg extends kwBsStMsg
{
    constructor(){super()}
}
